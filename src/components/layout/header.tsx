...
export function Header() {
  ...
  const getRoleLabel = () => {
    switch (session?.user?.role) {
      ...
      case "doctor": return "پزشک متخصص";
      case "clerk": return "مسئول پذیرش";
  ...
  return (
    <header className="bg-card-light dark:bg-card-dark border-b border-border-light dark:border-border-dark flex-none z-30 shadow-sm w-full relative">
        <div className="w-full mx-auto relative bg-card-light dark:bg-card-dark z-40">
            <div className="flex flex-col md:flex-row items-center h-auto md:h-20 gap-4 md:gap-0 py-3 md:py-0">
                ...
                <div className="hidden md:flex items-center gap-4 flex-none lg:w-72 px-6 h-full relative">
                    <div className="absolute left-0 top-1/2 -translate-y-1/2 h-[60%] w-px bg-border-light dark:bg-border-dark"></div>
                    <div className="w-10 h-10 rounded-full bg-primary-light dark:bg-primary-dark/20 border border-primary/20 dark:border-primary/50 text-primary-700 dark:text-primary-400 flex items-center justify-center font-bold text-lg shadow-sm relative">
                ...
                <div className="hidden md:flex flex-1 items-center justify-between px-6 h-full">
                    <div className="relative flex-1 max-w-lg mx-4">
                        <input className="w-full bg-gray-50 dark:bg-gray-800 border border-border-light dark:border-border-dark rounded-lg h-10 px-4 pl-10 text-sm focus:ring-2 focus:ring-primary/50 transition-all placeholder:text-gray-400 text-text-primary-light dark:text-text-primary-dark" placeholder="جستجوی سریع بیمار، کدملی یا پرونده..." type="text"/>
                    ...
                    <div className="flex items-center gap-4">
                        <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-gray-50 dark:bg-gray-800 border border-border-light dark:border-border-dark">
                            ...
                            <span className="text-xs font-medium text-text-primary-light dark:text-text-primary-dark">۱۶ بهمن ۱۴۰۲</span>
                        </div>
                        <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-gray-50 dark:bg-gray-800 border border-border-light dark:border-border-dark">
                            <span className="material-symbols-outlined text-text-secondary-light text-[18px]">schedule</span>
                            <span className="text-xs font-medium text-text-primary-light dark:text-text-primary-dark">۰۸:۳۰ صبح</span>
                        </div>
